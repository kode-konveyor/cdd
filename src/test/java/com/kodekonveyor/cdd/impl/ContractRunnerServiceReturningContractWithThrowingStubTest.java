...
@Behaviour("Returning contract fails if stub throws exception")
public class ContractRunnerServiceReturningContractWithThrowingStubTest {
  ...
  public void setUp() {
    ...
    contractRunnerServiceImpl
        .runChild(
            CDDContractTestData.RETURNING_CONTRACT_WITH_THROWING_STUB, notifier,
  ...
  @Test
  public void
      the_exception_is_the_one_thrown_by_the_service()
          throws Throwable {
    assertEquals(
  ...
  @Test
  public void
      the_exception_message_is_the_one_thrown_by_the_service()
          throws Throwable {
    assertEquals(
  ...
  @Test
  public void
      the_exception_trace_refers_to_the_service()
          throws Throwable {
    assertEquals(
